...
| 2 | **Never-called / coverage gap** — 25% of leads get no call (40% in winter peak); zero dialing after 17:00 vs ~30% out-of-hours arrivals; median first call 11–15h | P3 speed/ops tables | Recovering half the never-called gap ≈ **+150–300 appts/yr ≈ £150–300k revenue** | HIGH (gap) / MED (uplift) | Capacity + shift design, not effort — in-hours response is a 1-minute median. |

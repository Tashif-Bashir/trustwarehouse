...
case "$SOURCE" in
  wildix)
    ...
    ;;
  sharpspring)
    SELECTOR="sales_rep_mapping silver_sharpspring_leads silver_sharpspring_campaigns silver_sharpspring_opportunities silver_sharpspring_deal_stages silver_sharpspring_notes silver_google_ads_spend silver_meta_spend silver_bing_spend gold_lead_activity gold_lead_reenquiries gold_campaign_attribution gold_agent_performance_daily gold_pipeline_opportunities gold_sales_reconciled gold_sales_exceptions"
    ;;
  google_ads)
